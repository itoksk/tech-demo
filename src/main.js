...
for(let i=0;i<6;i++){
 ...
 const ignition=new THREE.Group();group.add(ignition);ignition.position.y=3.07;
 ...
 units.push({group,sleeve,piston,rod,big,head,valves,gas,label,button,ignition,flame});
}
